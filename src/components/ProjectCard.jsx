  ...
  return (
    <li className="project">
      ...
      <div className="project__content p-8 sm:px-10 sm:py-0 transition-all ease-in-out">
        <p className="text-green text-sm mt-4 mb-4">Featured Project</p>
        <h3 className="font-sans text-white font-semibold text-2xl capitalize mb-8">
          <a href={site} target="_blank" rel="noreferrer">
            {name}
          </a>
        </h3>
        <div className="project__content--paragraph sm:bg-lightNavy sm:shadow-sm sm:p-6 rounded">
        ...
        <ul className="text-sm sm:text-xs md:text-sm flex flex-wrap gap-2 mt-10 sm:mt-8 mb-5 items-center sm:justify-end">
          {technologies.map((tech, i) => {
            return (
              <li key={i} className="mx-0 px-1 py-[2px] bg-darkNavy/90 rounded">
                {tech}
              </li>
            );
          })}
